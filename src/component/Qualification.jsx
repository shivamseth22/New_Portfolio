...
const QualificationDetails = { q1: {
    ...
    to: "2019",
    inst: "UP Board",
    clg: "Shree Subhash Inter College",
    addr: "Varanasi, Uttar Pradesh",
    disc1: "Completed my 12th grade with 68% in the Science Stream.",
    disc2: "Successfully completed intermediate studies at Shree Subhash Inter College, focusing on developing tech-related skills problem-solving abilities, preparing for higher education.",
    },
    q2: {
    from: "2020",
    to: "2024",
    inst: "State Univeristy",
    clg: "Institute of Engineering and Technology",
    addr: "Ayodhya, Uttar Pradesh",
