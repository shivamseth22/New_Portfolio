        ...
        >
          <div id="hero" className=" md:w-4/6 ">
            ...
            <h1 className=" font-ubuntu text-4xl md:text-7xl text-slate-100 ">
              I develope & code for web.
            </h1>
            <p className=" md:w-2/3 text-sm md:text-lg text-slate-300 py-6">
              Frontend Web Developer with experience of Digital Concept Arts, Frontend
            ...
            <a href={resume} download="Shivam_resume">
              <button class="button">
            ...
            <div id="social" className=" flex py-10 gap-6  w-fit">
              ...
              <a href="https://www.instagram.com/btwishivam?igsh=MXhqa2Y0bTdpamIydw==" target="_blank"><img className=" w-8" src={insta} alt="" /></a>
